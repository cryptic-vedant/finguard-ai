  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0B1220] text-white flex-col justify-between p-12 relative overflow-hidden">
        <div className="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-[#0F9B8E]/10 blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 rounded-full bg-[#0F9B8E]/10 blur-3xl"></div>
        ...
        <div className="relative z-10">
          <h2 className="font-display text-4xl font-semibold leading-tight mb-4">
            Manage Smarter.<br />Spend Better.<br />Stay Protected.
          </h2>
          <p className="text-slate-400 max-w-sm">
            AI-powered categorization, fraud detection, and budget insights — all in one place.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#F6F7FB]">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-slate-500 mb-8">Log in to your FinGuard AI account</p>
          ...
          <p className="text-sm text-center mt-6 text-slate-500">
            ...
            <Link to="/register" className="text-[#0F9B8E] font-medium hover:underline">
              Create one
            </Link>
          </p>
        </div>
